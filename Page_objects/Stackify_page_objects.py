...
from Locators import Stackify_locators
import pytest
import time
from Locators.Stackify_locators import Stakify_headers
from PT_scripts.conftest import readJson


class Stakifyy_page_object:
    ...
    def click_reviewdoclink(self):
        #self.driver.execute_script("window.scrollTo(0, 1500)")#to scroll down the page
        #time.sleep(3)
        element = self.driver.find_element(By.XPATH, Stackify_locators.reviewdoc())
    ...
    def test_schedule_demo(self):
        ...
        #time.sleep(3)
        #to scroll down
        element = self.driver.find_element(By.XPATH, Stackify_locators.schedule_demo())
        actions = ActionChains(self.driver)
        actions.move_to_element(element).perform()
        time.sleep(1)
    ...
    def test_fillthe_details(self,readJson):
        ...
        #time.sleep(3)
        element=self.driver.find_element(By.XPATH,Stackify_locators.First_name())
        actions = ActionChains(self.driver)
        actions.move_to_element(element).perform()
